...
from users.views import (register, profile, en_profile, ro_register,
                         handle_login,
                         handle_logout,
                         profile_email,
                         contact_view,
...
urlpatterns = [
    ...
    path('register/en', view=register, name='en_register'),
    path('register/', view=ro_register, name='register'),
