...
class EnAudioModel(models.Model):
...
class EnAudioModelSound(models.Model):
    connection = models.ForeignKey(EnAudioModel, on_delete=models.CASCADE, default=None)
...
class EnAudioTitleTop(models.Model):
