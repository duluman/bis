...
class MyStory(models.Model):
    ...
    picture = models.ImageField(upload_to='story/', blank=True, null=True)
...
class StoryBackground(models.Model):
    title = models.CharField(max_length=255, default=None, blank=True)
    SIZE_CHOICE = [
        ('1', '1'),
        ('2', '2'),
...
class EnStoryBackground(models.Model):
    title = models.CharField(max_length=255, default=None, blank=True)
    SIZE_CHOICE = [
        ('1', '1'),
        ('2', '2'),
